...
SRC_DIRS := $(PROJECT_DIR) $(SOLUTION_DIR)public/
...
SRC_EXCLUDE := $(PROJECT_DIR)/ae_select.c $(PROJECT_DIR)ae_epoll.c $(PROJECT_DIR)ae_kqueue.c $(PROJECT_DIR)ae_evport.c
